...
{
    [TestClass]
    public class InformationResourceLogicTest
    {
        public IInformationResourceLogic informationResourceLogic;
        public IInformationResourceDAL informationResourceDAL;
        ...
        public InformationResourceLogicTest()
        {
            DependenciesResolver dependenciesResolver = new DependenciesResolver();
            informationResourceDAL = dependenciesResolver.InformationResourceDAL;
            informationResourceLogic = dependenciesResolver.InformationResourceLogic;
        }
        ...
        public void FindBooksByAuthorСoincidentallyTrue()
        {
            ...
            List<Book> books = informationResourceLogic.FindBooksByAuthor(author);
        ...
        {
            Author author = new Author("Ivan", "Ivanov");
            List<Patent> patents = informationResourceLogic.FindPatentsByAuthor(author);
        ...
        {
            Author author = new Author("Ivan", "Ivanov");
            List<InformationResource> patentsAndBooks = informationResourceLogic.FindPatentsAndBooksByAuthor(author);
        ...
        {
            List<InformationResource> informationResources = informationResourceLogic.FindResourcesByName("Club");
        ...
        {
            List<InformationResource> informationResources = informationResourceLogic.FindResourcesByName("No Club");
        ...
        public void GetLibraryTrue()
        {
            ...
            Assert.AreEqual(true, informationResourceLogic.GetLibrary() == informationResourceDAL.GetLibrary());
        }
        #endregion
        ...
        {
            Dictionary<string, List<Book>> books = informationResourceLogic.SmartBookSearchByPublisher("Sar");
        ...
        {
            List<InformationResource> informationResources = informationResourceLogic.GetSortedLibraryByYearOfPublishing(false);
        ...
        {
            List<InformationResource> informationResources = informationResourceLogic.GetSortedLibraryByYearOfPublishing(true);
            IEnumerable<IHaveYearOfPublishing> iHaveYearOfPublishingresources = informationResources.OfType<IHaveYearOfPublishing>();
        ...
        {
            Dictionary<int, List<InformationResource>> GroupingInformationResource = informationResourceLogic.GroupingResourceByYearOfPublication();
